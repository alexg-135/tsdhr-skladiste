...
<body>
    ...
    <table class="table table-striped" style="vertical-align: baseline;">
        ...
        <tbody>
            <?php
                $query = $DB->query("SELECT roba.*, vrstarobe.Naziv AS 'Vrsta', vrstarobe.Napomena, zakupac.Ime, zakupac.Prezime, zakupac.Telefon, zakupac.Mail FROM roba LEFT JOIN vrstarobe ON roba.VrstaRobe_ID = vrstarobe.ID LEFT JOIN zakupac ON roba.Zakupac_ID = zakupac.ID;");
